...
<div id="aka-store-stuff">
    ...
    <p>
        <strong><?php _e( 'Add New Store location:', 'aka-stores' ); ?></strong>
    </p>
    <table id="aka-newmeta">
        <thead>
            <tr>
                <th class="left"><label for="metakeyselect"><?php _e( 'Name', 'aka-stores' ); ?></label></th>
                <th><label for="metavalue"><?php _e( 'Location', 'aka-stores' ); ?></label></th>
                <?php
                if ( 1 == $aka_store_setting['show_url_field'] ) {
                    ?>
                    <th><label for="aka-url"><?php _e( 'Url', 'aka-stores' ); ?></label></th>
                    <?php
                }
                if ( 1 == $aka_store_setting['show_phone_field'] ) {
                    ?>
                    <th><label for="aka-phone"><?php _e( 'Phone', 'aka-stores' ); ?></label></th>
                    <?php
                }
                if ( 1 == $aka_store_setting['show_description_field'] ) {
                    ?>
                    <th><label for="aka-description"><?php _e( 'Description', 'aka-stores' ); ?></label></th>
                    <?php
                }
                ?>
